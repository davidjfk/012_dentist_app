...
import {createCombiOfPersonAndDayAndTime, generateAppointmentId, getNrOfRandomElementsFromArray, getRandomPersonIdAsync, getRandomDay, getRandomPersons, getRandomTime, selectObjectsByArrayObjectKey } from './utils';
...
const App = ()  => {
    ...
    // randomDentists = getRandomPersons(dentistsDentistCompanyBVT, 4);
      ...
      useEffect(() => {
          randomClients = getRandomPersons(clientsDentistCompanyBVT, 10);
        ...
        <Router>
          <div>
            <nav>
              <ul>  
              <li>
                <Link to="/dataToLoadWhenAppStarts">data to load when app starts</Link>
                </li> 
                <li>
            ...
            <main>
              ...
              <Switch>
              <Route path="/dataToLoadWhenAppStarts">  
                  <InitalDataSetup  />
                </Route>
                <Route path="/client">  
                  <Client  />
